...
class PVP:
    ...
    def _make_get_request(self, endpoint: str) -> Dict | int | None:
        """
        ...
        logger.debug(
            f'{__class__.__name__}.{self._make_get_request.__name__}: Making get request to endpoint {request_url}.')
        ...
        try:
            ...
            logger.warning(
                f'{__class__.__name__}.{self._make_get_request.__name__}: PVP machine at {self.ip}:{self.port} is either offline, PVP is not running, or the Network API is not configured correctly.')
            return None
    ...
    def _make_post_request(self, endpoint: str) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self._make_post_request.__name__}: Making post request to endpoint {request_url}.')
        ...
        try:
            requests.post(request_url)
                ...
                ConnectionRefusedError):
            logger.warning(
                f'{__class__.__name__}.{self._make_post_request.__name__}: PVP machine at {self.ip}:{self.port} is either offline, PVP is not running, or the Network API is not configured correctly.')

    def get_pvp_playlists(self) -> dict | None:
        """
        Get all playlists.
    ...
    def get_pvp_layers(self) -> dict | None:
        """
        Get all layers
        :return: All layers.
        """
    ...
    def does_cue_exist(self, playlist_uuid: str, cue_uuid: str) -> bool:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.does_cue_exist.__name__}: Checking to see if cue exists on machine {self.ip}:{self.port}. playlist_uuid: {playlist_uuid}, cue_uuid: {cue_uuid}')
    ...
    def cue_clip(self, playlist: str, cue: str) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.cue_clip.__name__}: Triggering cue {cue} in playlist {playlist} on machine {self.ip}:{self.port}')
    ...
    def clear_workspace(self) -> None:
        ...
        """
        logger.debug(
            f'{__class__.__name__}.{self.clear_workspace.__name__}: Clearing workspace on machine {self.ip}:{self.port}')
    ...
    def clear_layer(self, layer_id: str) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.clear_layer.__name__}: Clearing layer {layer_id} on machine {self.ip}:{self.port}')
    ...
    def mute_workspace(self) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.mute_workspace.__name__}: Muting workspace on pvp machine {self.ip}:{self.port}')
    ...
    def unmute_workspace(self) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.unmute_workspace.__name__}: Unmuting workspace on pvp machine {self.ip}:{self.port}')
    ...
    def mute_layer(self, layer_id) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.mute_layer.__name__}: Muting layer {layer_id} on pvp machine {self.ip}:{self.port}')
    ...
    def unmute_layer(self, layer_id) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.mute_layer.__name__}: Unmuting layer {layer_id} on pvp machine {self.ip}:{self.port}')
    ...
    def hide_workspace(self) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.hide_workspace.__name__}: Hiding workspace on pvp machine {self.ip}:{self.port}')
    ...
    def unhide_workspace(self) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.unhide_workspace.__name__}: Unhiding workspace on pvp machine {self.ip}:{self.port}')
    ...
    def hide_layer(self, layer_id) -> None:
        ...
        """
        logger.debug(
            f'{__class__.__name__}.{self.hide_layer.__name__}: Hiding layer {layer_id} on pvp machine {self.ip}:{self.port}')
    ...
    def unhide_layer(self, layer_id) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.hide_layer.__name__}: Unhiding layer {layer_id} on pvp machine {self.ip}:{self.port}')
    ...
    def pause_workspace(self) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.pause_workspace.__name__}: Pausing workspace on pvp machine {self.ip}:{self.port}')
    ...
    def unpause_workspace(self) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.unpause_workspace.__name__}: Unpausing workspace on pvp machine {self.ip}:{self.port}')
    ...
    def pause_layer(self, layer_id) -> None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.pause_layer.__name__}: Pausing layer {layer_id} on pvp machine {self.ip}:{self.port}')
    ...
    def cue_name_from_uuids(self, playlist_uuid: str, cue_uuid: str) -> str | None:
        ...
        logger.debug(
            f'{__class__.__name__}.{self.cue_name_from_uuids.__name__}: Getting clip name from playlist id {playlist_uuid}, cue uuid {cue_uuid} on machine {self.ip}:{self.port}')
    ...
    def get_layer_name_from_uuid(self, layer_uuid: str) -> str | None:
        ...
        """
        logger.debug(
            f'{__class__.__name__}.{self.get_layer_name_from_uuid.__name__}: Getting layer name from uuid {layer_uuid} on machine {self.ip}:{self.port}')
