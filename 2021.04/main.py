...
def service_selected(service_type_id, service_index):
    ...
    plan_app_cue_note_category_id = pco_plan_update.get_service_cateogry_app_cue_note_category_id(service_type=plan_main_info['folder_id'])
    ...
    for iteration, data in enumerate(plan_items['data']):
        ...
        items_master.update({
            iteration: {
                ...
                'app_cues_note_category_id': plan_app_cue_note_category_id,
                'item_id': data['id'],
